...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autosizeTextarea = __webpack_require__(69);
	...
	new _vue2['default']({
	  ...
	  components: {
	    'autosize-textarea': _autosizeTextarea2['default']
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autosize = __webpack_require__(70);

	var _autosize2 = _interopRequireDefault(_autosize);

	var template = '<textarea>{{ value }}</textarea>';

	var autosizeTextarea = _vue2['default'].extend({
	  props: ['value', 'resized'],
	  template: template,
